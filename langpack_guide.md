...
If an error is encountered, the error message, [optional] stacktrace and [optional] code should be written to the `algoout` pipe as compact JSON in the following format:
